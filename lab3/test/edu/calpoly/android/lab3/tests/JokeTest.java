...
public class JokeTest extends TestCase {
	...
	public void testJoke() {
		...
		assertEquals("m_nRating should be initialized to Joke.UNRATED.", Joke.Rating.Unrated, joke.getRating());
	}
	...
	public void testJokeStringInt() {
		String strJoke = "testJoke";
		Joke joke = new Joke(strJoke, Joke.Rating.Dislike);
		assertEquals("m_strJoke should be initialized to \"testJoke\".", strJoke, joke.getJoke());
		assertEquals("m_nRating should be initialized to Joke.DISLIKE.", Joke.Rating.Dislike, joke.getRating());
	}
	...
	public void testSetRating() {
		Joke joke = new Joke();
		joke.setRating(Joke.Rating.Like);
		assertEquals("m_nRating should be set to Joke.LIKE.", Joke.Rating.Like, joke.getRating());
	}
